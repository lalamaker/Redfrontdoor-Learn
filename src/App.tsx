...
import peacefulParentingSections from "./sections/peaceful-parenting/index"; // Import Peaceful Parenting content
import adultChildParentSections from "./sections/adult-child-parent/index"; // Import Adult Child-Parent content
...
const DesignAdventureApp = ({ gameId, onReturnHome }) => {
  ...
  const gameConfig = {
    title:
      gameId === "peaceful-parenting"
        ? "Peaceful Parenting Journey"
        : "Compassionate Boundaries Journey",
    emoji: gameId === "peaceful-parenting" ? "💝" : "❤️",
  };
  ...
  useEffect(() => {
    ...
    if (gameId === "peaceful-parenting") {
      gameSections = peacefulParentingSections;
    } else if (gameId === "adult-child-parent") {
      gameSections = adultChildParentSections;
    }
